...
export default function ServicesSection() {
  return (
    <div className="relative flex px-20 md:px-4  w-full flex-col">
      ...
      <div className="flex flex-col lg:flex-row lg:absolute lg:top-1/2 lg:right-6 lg:transform lg:-translate-y-1/2 lg:gap-6 lg:w-fit lg:max-w-[680px] lg:mb-0 mb-6">
        <Card className="w-full lg:w-[680px] max-w-[full]">
